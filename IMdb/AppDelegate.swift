...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func personalizarUI(){
        ...
        let nabVar = UINavigationBar.appearance()
        let tabBar = UITabBar.appearance()
        
        nabVar.barTintColor = CONSTANTES.COLORES.COLOR_GRIS_TAB_NAV_BAR
        nabVar.tintColor = CONSTANTES.COLORES.COLOR_ROJO_GENERAL
        nabVar.titleTextAttributes = [NSForegroundColorAttributeName : CONSTANTES.COLORES.COLOR_ROJO_GENERAL]
